(function(){
    var unitPositionsInfo = function () {
        return {
            restrict: 'E',
            templateUrl: 'unit/charts/positions/template.html'
        };
    };
    var positionsChart = function (d3) {
        return {
            restrict: 'E',
            scope: {
                info: '=',
    ...
    angular.module('managementApp')
        .directive('unitPositionsInfo', unitPositionsInfo)
        .directive('positionsChart', ['d3', positionsChart])
